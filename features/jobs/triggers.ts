import type { AudioAsset, CaptureId, DataGeneration, ReportField, ReportRevision, TranscriptSnapshot } from '../domain/contracts';
...
export function transcriptionJob(
  input: CommonTrigger & Readonly<{ audio: AudioAsset; expectedTranscriptRevision: number }>,
): JobEnqueueInput {
  return {
...
export function initialCaptureJobs(input: Readonly<{
  captureId: CaptureId;
  generation: DataGeneration;
  audio: AudioAsset;
