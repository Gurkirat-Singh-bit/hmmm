...
export type JobStatus = 'queued' | 'running' | 'retry-wait' | 'succeeded' | 'failed' | 'cancelled';
...
export type JobRecord = {
  [Kind in JobKind]: JobRecordBase & Readonly<{
    kind: Kind;
...
export interface JobRepository {
  ...
  claimNext(now: IsoTimestamp, leaseUntil: IsoTimestamp): Promise<JobRecord | null>;
  succeed(id: string, expectedGeneration: DataGeneration, completedAt: IsoTimestamp): Promise<void>;
  retry(id: string, expectedGeneration: DataGeneration, runAfter: IsoTimestamp, error: NormalizedError): Promise<void>;
  fail(id: string, expectedGeneration: DataGeneration, failedAt: IsoTimestamp, error: NormalizedError): Promise<void>;
  cancelForCapture(captureId: CaptureId, expectedGeneration: DataGeneration, cancelledAt: IsoTimestamp): Promise<void>;
