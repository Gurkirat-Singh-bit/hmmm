...
/**
 * Performs discussion composer for its owning feature.
 * @param {
  availability,
  sending,
  value,
 ...
 * @throws When required validation, storage, platform, or provider work fails.
 */
      ...
      <View style={[styles.composer, unavailable && styles.composerDisabled]}>
        ...
        >
          {sending ? (
            ...
            <PaperPlaneTilt color={colors.inkInverse} size={19} weight="fill" />
          )}
        </Pressable>
      </View>
    </View>
