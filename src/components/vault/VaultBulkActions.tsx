/**
 * @file VaultBulkActions.tsx
 * @description Bulk export and deletion controls for selected Vault ideas.
  ...
  return (
    <View style={styles.wrap}>
      <Text accessibilityLiveRegion="polite" style={styles.count}>
        {count === 1 ? "1 idea selected" : `${count} ideas selected`}
      </Text>
      <View style={styles.actions}>
        ...
        >
          <Export color={colors.ink} size={19} weight="bold" />
        ...
        >
          <Trash color={colors.ink} size={19} weight="bold" />
