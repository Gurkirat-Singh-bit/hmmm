...
export default function ProvidersScreen() {
  ...
  return (
    <SettingsSubpage
      supporting="Repair provider choices safely. Hmmmidea verifies the selected speech and AI setups before saving."
      title="Providers & models"
    >
      <ProviderSettingsEditor settings={settings} />
      {settings.message ? (
      ...
      <Pressable
        accessibilityLabel="Verify both providers and save settings"
      ...
      >
        {settings.saving ? (
          ...
          <Text style={styles.buttonText}>Verify and save providers</Text>
        )}
      </Pressable>
    </SettingsSubpage>
  );
