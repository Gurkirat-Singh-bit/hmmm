...
const sections = [
  [
    "Local by default",
    "Your ideas, reports, and job state are stored on your device. Hmmmidea does not require an application account or backend.",
  ],
  [
    "Provider requests",
  ...
  [
    ...
    "Provider API keys are stored using your operating system’s protected keychain or keystore and are excluded from data exports.",
  ],
  [
    "Research consent",
  ...
  [
    "Your control",
    "You can export non-secret data, turn background completion alerts on or off, delete all ideas while keeping setup, or fully reset the app.",
  ],
  [
    "What Hmmmidea does not collect",
    "The initial architecture has no Hmmmidea account, advertising profile, analytics requirement, or application server receiving your idea library.",
  ],
  [
    "Audio and generated content",
    "Source audio is retained in the app’s local filesystem until you delete its idea or reset the app. Transcripts, reports, discussion messages, and processing state live in the local database.",
  ],
  [
    "Network boundaries",
  ...
  [
    ...
    "Local content remains on the device until you delete it or remove the app’s data. Provider-side retention is controlled by the provider’s own terms and settings.",
  ],
  [
    "Exports",
    "Exports intentionally omit provider API keys. Review exported content before sharing it because it may contain your profile name, provider choices, models, or future idea content you select.",
  ],
] as const;
export default function PrivacyScreen() {
  return (
    <SettingsSubpage
      supporting="A concise explanation of what leaves your device and what does not."
