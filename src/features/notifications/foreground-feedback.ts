/**
 * @file foreground-feedback.ts
 * @description Small event channel for completion feedback while the app is visible.
...
export function subscribeToForegroundFeedback(
  listener: (feedback: ForegroundFeedback) => void,
) {
