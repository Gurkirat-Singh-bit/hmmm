...
export const speechProviders = [
  {
    id: "deepgram",
    label: "Deepgram",
    description: "Live and saved transcription",
    modelsUrl: "https://api.deepgram.com/v1/models",
    authentication: "deepgram",
    starterModels: ["nova-3", "nova-2", "whisper"],
  },
  {
    id: "groq",
    label: "Groq",
    description: "Very fast Whisper transcription",
    modelsUrl: "https://api.groq.com/openai/v1/models",
    authentication: "bearer",
    starterModels: ["whisper-large-v3-turbo", "whisper-large-v3"],
  },
  {
    id: "openai",
    label: "OpenAI",
    description: "OpenAI speech-to-text models",
    modelsUrl: "https://api.openai.com/v1/models",
    authentication: "bearer",
    starterModels: ["gpt-4o-mini-transcribe", "gpt-4o-transcribe", "whisper-1"],
  },
  {
    id: "openrouter",
    label: "OpenRouter",
    description: "Dedicated speech-to-text routing",
    modelsUrl:
  ...
  },
  {
    id: "google",
    label: "Google Gemini",
    description: "Gemini audio transcription",
    modelsUrl:
      "https://generativelanguage.googleapis.com/v1beta/models?pageSize=1000",
    authentication: "google",
    starterModels: ["gemini-3.7-flash", "gemini-3.6-flash", "gemini-2.5-flash"],
  },
  {
    id: "custom",
    label: "Custom",
    description: "HTTPS OpenAI-compatible endpoint",
    modelsUrl: null,
...
export const aiProviders = [
  {
    ...
    authentication: "optional-bearer",
    starterModels: ["openrouter/auto"],
  },
  {
    id: "claude",
    label: "Claude",
    description: "Models directly from Anthropic",
    modelsUrl: "https://api.anthropic.com/v1/models",
    authentication: "anthropic",
    starterModels: ["claude-opus-4-8", "claude-sonnet-4-6", "claude-haiku-4-5"],
  },
  {
    id: "openai",
    label: "OpenAI",
    description: "Models directly from OpenAI",
    modelsUrl: "https://api.openai.com/v1/models",
    authentication: "bearer",
    starterModels: ["gpt-5", "gpt-5-mini", "gpt-4.1", "gpt-4.1-mini"],
  },
  {
    id: "groq",
    label: "Groq",
    description: "Low-latency open models",
    modelsUrl: "https://api.groq.com/openai/v1/models",
    authentication: "bearer",
    starterModels: [
      "openai/gpt-oss-120b",
...
export function findSpeechProvider(id: string | null | undefined) {
  return (
    speechProviders.find((provider) => provider.id === id) ?? speechProviders[0]
  );
}
