...
import { onboardingStepCount, useOnboardingFlow } from '@/features/onboarding/use-onboarding-flow';
...
const styles = StyleSheet.create({
  ...
  topBar: { zIndex: 1, gap: 8, paddingHorizontal: spacing.page, paddingTop: 8, paddingBottom: 12, backgroundColor: colors.darkCanvas },
  ...
  content: { flexGrow: 1, paddingHorizontal: spacing.page, paddingTop: 13, paddingBottom: 28 },
});
