...
const sections = [
  ...
  ['Provider requests', 'Audio or text is sent directly to the speech and AI providers you configure only when their service is needed. Their own privacy terms apply.'],
  ...
  ['Your control', 'You can export your non-secret configuration and remove local app data through your device settings.'],
  ...
  ['Audio and generated content', 'Optional source audio stays in the app’s local filesystem. Transcripts, reports, discussion messages, and processing state are designed to live in the local database.'],
